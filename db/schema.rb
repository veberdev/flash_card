...
ActiveRecord::Schema[7.0].define(version: 2022_09_11_160714) do
  ...
  create_table "decks", force: :cascade do |t|
    ...
    t.integer "correct_times_rate", default: 0, null: false
    t.integer "questions_times_done", default: 0, null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "questios_contained", default: 0, null: false
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.string "wrong_answer_n1"
    t.string "wrong_answer_n2"
    t.string "wrong_answer_n3"
